 ...
 */
public final class ControllerInternet_OLD {
    ...
    public ControllerInternet_OLD(Controller who_I_am_providing_internet_to) {
    ...
    public IO_Bundle sendStuffToMap(String avatar_name, Enum key_command, int width, int height, String optional_text) {
        ...
        try {
            ...
            final DatagramPacket packet = new DatagramPacket(buf, buf.length, address, MapInternet.UDP_PORT_NUMBER_FOR_MAP_RECIEVING_AND_CLIENT_SENDING);
            if (udp_socket_for_incoming_signals != null) {
    ...
    private IO_Bundle getBundleFromBufferOfSize(int buffer_size) {
        ...
        while (is_too_small) {
            ...
            try {
                udp_socket_for_incoming_signals.setSoTimeout(10);
 ...
 use sendStuffToMap(String, Enum, int, int, "")
     *
